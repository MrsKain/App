...
namespace Dinner.Controllers
{
    ...
    public class MainsController : Controller
    {
        ...
        private LoginGameUser _logingameUser = null;
        /// <summary>
        /// 返回用户类实例（会员）
        /// </summary>
        public LoginGameUser LgGameUser
        {
            get
            {
                if (_logingameUser == null)
                {
                    return (LoginGameUser)Session["LgGameuser"];
                }
                else
                {
                    return _logingameUser;
                }
